...
class FlutterBarcodeScanner {
  ...
  static const MethodChannel _channel = const MethodChannel('flutter_barcode_scanner');

  static const EventChannel _eventChannel = const EventChannel('flutter_barcode_scanner_receiver');
